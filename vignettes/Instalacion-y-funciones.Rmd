...
```{r, include= FALSE}
timeline_af <- readRDS("~/Documents/GitHub/politicxsentwitteR/data_v/timeline_af.rds")
```
...
```{r, include= FALSE}
timeline_pb_mm <- readRDS("~/Documents/GitHub/politicxsentwitteR/data_vtimeline_pb_mm.rds")
```
...
```{r, include= FALSE}
foll_friends_mv_hl <- readRDS("~/Documents/GitHub/politicxsentwitteR/foll_friends_mv_hl.rds")
```
...
```{r, include= FALSE}
others_network <- readRDS("~/Documents/GitHub/politicxsentwitteR/others_network.rds")
```
